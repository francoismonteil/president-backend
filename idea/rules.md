...
### 2.4 Joueurs Contrôlés par l'IA
...
Un pli peut se terminer de plusieurs manières :
####  Fin par passes consécutives
Un pli se termine lorsque tous les joueurs ont passé consécutivement.
Le dernier joueur à avoir posé une ou plusieurs cartes :
* entame le nouveau pli
* peut jouer la carte ou la combinaison de son choix, indépendamment des cartes jouées précédemment.

👉 Tant qu’il n’a pas passé, ce joueur peut continuer à jouer seul, en posant de nouvelles cartes ou combinaisons successives, jusqu’à décider de passer ou ne plus pouvoir jouer.

#### Fin immédiate par carré
Un pli se termine immédiatement lorsqu’un joueur pose un carré (quatre cartes de même rang), que ce carré soit :
* posé en une seule fois
* ou complété par-dessus des cartes de même rang précédemment posées de manière unitaire par d’autres joueurs.

Dans ce cas :
* le pli est immédiatement clos
* le joueur ayant posé le carré entame le nouveau pli.

#### Fin immédiate par carte de rang 2 (ou 3 en cas de révolution)
En ordre normal, jouer un 2 termine immédiatement le pli :
* aucun joueur ne peut surenchérir sur un 2
* le joueur ayant posé le 2 entame le nouveau pli.

En cas de révolution, ces propriétés sont transférées à la carte de rang 3 :
* le 3 devient la carte la plus forte
* jouer un 3 termine immédiatement le pli.

#### Exemple
Si le joueur A joue un 9, puis les joueurs B, C et D passent successivement.

Tant qu’il ne passe pas, A peut continuer à jouer seul. Lorsqu’il passe (ou ne peut plus jouer), le pli se termine.

Le joueur A commence alors le nouveau pli et peut décider de jouer une nouvelle carte ou combinaison.

### 3.4 Règles Générales de Jeu
...
* **Joueurs Neutres** : joueurs suivants jusqu’à l’avant-dernier.
* **Vice-Trouduc** : avant-dernier joueur ayant encore des cartes en main.
* **Trouduc** : Le dernier joueur ayant encore des cartes en main.

**Cas particulier — fin avec un 2 (ou un 3 en cas de révolution)**
Si un joueur termine la manche en posant un 2 comme dernière carte de sa main, il devient automatiquement Trouduc, même s’il est le premier à s’être débarrassé de toutes ses cartes.
En cas de révolution, cette règle s’applique à la carte de rang 3, qui hérite des propriétés du 2.

#### Redistribution des Cartes pour la Nouvelle Manche
Avant le début de la manche suivante, des échanges de cartes ont lieu en fonction des rangs obtenus :

1. **Échange Président / Trouduc**
   * Le Président donne deux cartes de son choix au Trouduc.
   * Le Trouduc donne ses deux meilleures cartes au Président.

2. **Échange Vice-Président / Vice-Trouduc**
   * Le Vice-Président donne une carte de son choix au Vice-Trouduc.
   * Le Vice-Trouduc donne sa meilleure carte au Vice-Président.

3. **Joueurs Neutres**
   * Les joueurs neutres ne participent à aucun échange et conservent leurs cartes.
...
* l’ordre hiérarchique en vigueur.

**Hiérarchie normale** de la carte la moins forte à la plus forte
3, 4, 5, ..., 10, Valet (J), Dame (Q), Roi (K), As (A), 2

**Hiérarchie inversée (Révolution)** de la carte la moins forte à la plus forte
2, As (A), Roi (K), Dame (Q), Valet (J), 10, ..., 4, 3
...
**Important** :
Lorsqu’un joueur passe pendant une suite, il est définitivement sorti du pli en cours et ne peut plus intervenir jusqu’au pli suivant, même si la suite se poursuit.

#### Fin de la Suite
La suite prend fin lorsque :
* tous les joueurs ont passé consécutivement
* ou que la carte terminale de l’ordre hiérarchique est jouée :
  * le 2 en hiérarchie normale
  * le 3 en cas de révolution.

Le dernier joueur à avoir posé une carte lors de la suite entame alors un nouveau pli avec la carte ou la combinaison de son choix.

### 4.2 Le Reverse

#### Activation du Reverse
Un joueur peut activer le reverse uniquement s’il est le deuxième à jouer lors d’un pli.
...
**En hiérarchie normale**
Si un 9 est joué, le joueur suivant doit jouer un 8.

**En hiérarchie inversée (Révolution)**
Si un 4 est joué, le joueur suivant doit jouer un 5.

**Exemples** :
* Si le premier joueur joue un 6 et que le deuxième joueur active le reverse en jouant un 5, les joueurs suivants doivent jouer un 4, puis un 3.
* Le 3 constitue la borne terminale en hiérarchie normale : il n’est pas possible de jouer une carte inférieure.
      
#### Fin du Reverse
* Le reverse s’applique uniquement au pli en cours.
* À la fin du pli, l’ordre de jeu redevient celui défini par l’état global de la manche (ordre normal ou révolution).

Si un joueur se retrouve le dernier à pouvoir jouer lors d’un reverse :
* il peut continuer à jouer tant qu’il le souhaite
* ou décider de passer pour clore le pli.
...
**Exemple** :
Si le Joueur A joue un 7 et que le Joueur B joue également un 7, la règle du Ou-Rien est déclenchée.

#### Effet de la Règle
Lorsque le Ou-Rien est actif :
* le joueur suivant est obligé de jouer une carte du même rang que celui ayant déclenché la règle
* s’il ne possède pas de carte de ce rang, il doit passer son tour.

#### Désactivation et Réactivation
* La règle du Ou-Rien reste active jusqu’à ce qu’un joueur soit contraint de passer faute de pouvoir jouer une carte du rang requis.
* Lorsqu’un joueur passe dans ce contexte, le Ou-Rien est désactivé.

**Réactivation possible** :
Si, après cette désactivation, un joueur joue à nouveau une carte du même rang que celui concerné, le Ou-Rien est immédiatement réactivé.

**Exemple** :
* Joueur A joue un 3.
* Joueur B joue un 3 → Ou-Rien activé.
* Joueur C ne possède pas de 3 et passe → Ou-Rien désactivé.
* Joueur D joue un 3 → Ou-Rien réactivé.
* Joueur A est alors obligé de jouer un 3 s’il en possède un, ou de passer.

#### Remarques
* La règle du Ou-Rien ne peut pas être activée avec la carte de rang 2.
* Le Ou-Rien est basé exclusivement sur le rang des cartes et n’est pas affecté par l’ordre hiérarchique (normal ou révolution).

### 4.6 La Carte de Rang 2
#### Pouvoir Spécial du 2
En ordre hiérarchique normal, la carte de rang 2 est la carte la plus forte.

Jouer un 2 :
* termine immédiatement le pli en cours
* empêche toute surenchère
* permet au joueur ayant posé le 2 d’entamer le nouveau pli.

#### Exception — Finir la Manche avec un 2
Si un joueur termine la manche en jouant un 2 comme dernière carte de sa main, il devient automatiquement Trouduc, même s’il est le premier joueur à s’être débarrassé de toutes ses cartes.

#### Cas de la Révolution
En cas de révolution :
* la hiérarchie des cartes est inversée
* la carte de rang 3 hérite des propriétés spéciales du 2.

Ainsi :
* jouer un 3 termine immédiatement le pli
* terminer la manche avec un 3 comme dernière carte entraîne automatiquement le rang de Trouduc, même si le joueur est le premier à finir.
...
* L’ordre des cartes est inversé pour toute la manche.
  * **Hiérarchie inversée** de la carte la moins forte à la plus forte 2, As (A), Roi (K), Dame (Q), Valet (J), 10, ..., 4, 3
...
Cette section précise les interactions possibles entre les règles spéciales, ainsi que les cas d’exclusivité ou d’incompatibilité.

#### Portée des Règles
* **Révolution**
  * Portée : toute la manche
  * Effet : inverse la hiérarchie globale des cartes.
* **Suite et Reverse**
  * Portée : pli en cours uniquement
  * Effet : impose une progression consécutive (suite) ou inversement consécutive (reverse).
  * Exclusivité : une suite et un reverse ne peuvent jamais être actifs simultanément.
* **Ou-Rien**
  * Portée : jusqu’à désactivation par une passe forcée.
  * Effet : contraint les joueurs à jouer un rang précis.

#### Règles d’Exclusivité et d’Impossibilité
* **Suite et Reverse**
  * Une suite ou un reverse ne peut être déclenché que par le deuxième joueur d’un pli.
  * Il est donc impossible d’activer un reverse pendant une suite, ou inversement.
* **Ou-Rien avec Suite ou Reverse**
  * Le Ou-Rien nécessite que deux cartes de même rang soient jouées consécutivement.
  * Dans une suite ou un reverse, les cartes jouées sont par définition de rang différent.
  * Il est donc impossible d’activer un Ou-Rien pendant une suite ou un reverse.
